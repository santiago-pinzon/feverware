    ...
    return (
        <>
            ...
            <div className={`${booted ? 'opacity-100' : 'opacity-0'} transition-opacity duration-700`}>
                {/* Top Marquee */}
                <div
                    className={`fixed top-0 left-0 w-full z-20 transition-transform duration-700 ${showMarquees ? 'translate-y-0' : '-translate-y-12'}`}
                >
                ...
                {/* Bottom Marquee */}
                <div
                    className={`fixed bottom-0 left-0 w-full z-20 transition-transform duration-700 ${showMarquees ? 'translate-y-0' : 'translate-y-12'}`}
                >
                    <Marquee text={message} reverse duration={60} />
                </div>

                {/* Main Section */}
                <div className="relative min-h-screen bg-black text-lime-300 font-mono flex flex-col justify-center items-center p-8 pt-24 pb-24">
                    <h1 className="text-4xl text-white text-center z-10 mt-20">Main Page</h1>
                </div>
